...
For non-connected components, you may want to check what props are being passed in. A common issue is having a parent component re-bind a callback inside its render function, like `Further information# `
...
- <a href="#react-redux" class="table-of-contents__link">React Redux</a>
  ...
  - <a href="#how-can-i-speed-up-my-mapstatetoprops" class="table-of-contents__link">How can I speed up my <code class="language-js">mapStateToProps</code>?</a>
  - <a href="#why-dont-i-have-thispropsdispatch-available-in-my-connected-component" class="table-of-contents__link">Why don't I have <code class="language-js">this.props.dispatch</code> available in my connected component?</a>
