...
<span class="token plain"></span><span class="token punctuation" style="color: #f8f8f2">}</span>To add a new reducer, one can now call `store.reducerManager.remove("asyncState")`
...
-   <a href="#basic-principle" class="table-of-contents__link">Basic Principle</a>
    -   <a href="#using-replacereducer" class="table-of-contents__link">Using <code class="language-js">replaceReducer</code></a>
-   <a href="#reducer-injection-approaches" class="table-of-contents__link">Reducer Injection Approaches</a>
    -   <a href="#defining-an-injectreducer-function" class="table-of-contents__link">Defining an <code class="language-js">injectReducer</code> function</a>
