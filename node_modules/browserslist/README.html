...
<body>
<h1 id="browserslist-cult-of-martianscult-imgcult">Browserslist <a href="https://cultofmartians.com/done.html"><img src="https://cultofmartians.com/assets/badges/badge.svg" alt="Cult Of Martians" /></a></h1>
...
<div class="sourceCode" id="cb1"><pre class="sourceCode json"><code class="sourceCode json"><a class="sourceLine" id="cb1-1" title="1">  <span class="er">&quot;browserslist&quot;:</span> <span class="ot">[</span></a>
<a class="sourceLine" id="cb1-2" title="2">    <span class="st">&quot;defaults&quot;</span><span class="ot">,</span></a>
<a class="sourceLine" id="cb1-3" title="3">    <span class="st">&quot;not IE 11&quot;</span><span class="ot">,</span></a>
<a class="sourceLine" id="cb1-4" title="4">    <span class="st">&quot;maintained node versions&quot;</span></a>
<a class="sourceLine" id="cb1-5" title="5">  <span class="ot">]</span></a></code></pre></div>
<p>Or in <code>.browserslistrc</code> config:</p>
<div class="sourceCode" id="cb2"><pre class="sourceCode yaml"><code class="sourceCode yaml"><a class="sourceLine" id="cb2-1" title="1"><span class="co"># Browsers that we support</span></a>
<a class="sourceLine" id="cb2-2" title="2"></a>
<a class="sourceLine" id="cb2-3" title="3">defaults</a>
<a class="sourceLine" id="cb2-4" title="4">not IE 11</a>
<a class="sourceLine" id="cb2-5" title="5">maintained node versions</a></code></pre></div>
...
<p><a href="https://evilmartians.com/?utm_source=browserslist"> <img src="https://evilmartians.com/badges/sponsored-by-evil-martians.svg"
...
<ul>
<li><p>There is a <code>defaults</code> query, which gives a reasonable configuration for most users:</p>
<div class="sourceCode" id="cb3"><pre class="sourceCode json"><code class="sourceCode json"><a class="sourceLine" id="cb3-1" title="1">  <span class="er">&quot;browserslist&quot;:</span> <span class="ot">[</span></a>
<a class="sourceLine" id="cb3-2" title="2">    <span class="st">&quot;defaults&quot;</span></a>
<a class="sourceLine" id="cb3-3" title="3">  <span class="ot">]</span></a></code></pre></div></li>
...
<li><p>Don’t remove browsers just because you don’t know them. Opera Mini has 100 million users in Africa and it is more popular in the global market than Microsoft Edge. Chinese QQ Browsers has more market share than Firefox and desktop Safari combined.</p></li>
</ul>
<h2 id="browsers-data-updating">Browsers Data Updating</h2>
...
<div class="sourceCode" id="cb4"><pre class="sourceCode ocaml"><code class="sourceCode ocaml"><a class="sourceLine" id="cb4-1" title="1">autoprefixer <span class="fl">7.1</span>.<span class="dv">4</span></a>
<a class="sourceLine" id="cb4-2" title="2">  browserslist <span class="fl">3.1</span>.<span class="dv">1</span></a>
<a class="sourceLine" id="cb4-3" title="3">    caniuse-lite <span class="fl">1.0</span>.<span class="dv">30000700</span></a>
<a class="sourceLine" id="cb4-4" title="4">@babel/preset-env <span class="fl">7.10</span>.<span class="dv">0</span></a>
<a class="sourceLine" id="cb4-5" title="5">  browserslist <span class="fl">4.13</span>.<span class="dv">0</span></a>
<a class="sourceLine" id="cb4-6" title="6">    caniuse-lite <span class="fl">1.0</span>.<span class="dv">30000900</span></a></code></pre></div>
...
<h3 id="query-composition">Query Composition</h3>
...
<td style="text-align: center;"><img src="img/union.svg" alt="Union of queries" /></td>
<td><code>&gt; .5% or last 2 versions</code> <br> <code>&gt; .5%, last 2 versions</code></td>
</tr>
<tr class="even">
<td><code>and</code> combiner <br> (intersection)</td>
<td style="text-align: center;"><img src="img/intersection.svg" alt="intersection of queries" /></td>
<td><code>&gt; .5% and last 2 versions</code></td>
</tr>
<tr class="odd">
<td><code>not</code> combiner <br> (relative complement)</td>
<td style="text-align: center;"><img src="img/complement.svg" alt="Relative complement of queries" /></td>
...
<li><code>browserslist config</code>: the browsers defined in Browserslist config. Useful in Differential Serving to modify user’s config like <code>browserslist config and supports es6-module</code>.</li>
...
<div class="sourceCode" id="cb5"><pre class="sourceCode sh"><code class="sourceCode bash"><a class="sourceLine" id="cb5-1" title="1">$ <span class="ex">npx</span> browserslist</a>
<a class="sourceLine" id="cb5-2" title="2"><span class="ex">and_chr</span> 61</a>
<a class="sourceLine" id="cb5-3" title="3"><span class="ex">and_ff</span> 56</a>
<a class="sourceLine" id="cb5-4" title="4"><span class="ex">and_qq</span> 1.2</a>
<a class="sourceLine" id="cb5-5" title="5"><span class="ex">and_uc</span> 11.4</a>
<a class="sourceLine" id="cb5-6" title="6"><span class="ex">android</span> 56</a>
<a class="sourceLine" id="cb5-7" title="7"><span class="ex">baidu</span> 7.12</a>
<a class="sourceLine" id="cb5-8" title="8"><span class="ex">bb</span> 10</a>
<a class="sourceLine" id="cb5-9" title="9"><span class="ex">chrome</span> 62</a>
<a class="sourceLine" id="cb5-10" title="10"><span class="ex">edge</span> 16</a>
<a class="sourceLine" id="cb5-11" title="11"><span class="ex">firefox</span> 56</a>
<a class="sourceLine" id="cb5-12" title="12"><span class="ex">ios_saf</span> 11</a>
<a class="sourceLine" id="cb5-13" title="13"><span class="ex">opera</span> 48</a>
<a class="sourceLine" id="cb5-14" title="14"><span class="ex">safari</span> 11</a>
<a class="sourceLine" id="cb5-15" title="15"><span class="ex">samsung</span> 5</a></code></pre></div>
...
<a class="sourceLine" id="cb6-2" title="2">  <span class="dt">&quot;private&quot;</span><span class="fu">:</span> <span class="kw">true</span><span class="fu">,</span></a>
<a class="sourceLine" id="cb6-3" title="3">  <span class="dt">&quot;dependencies&quot;</span><span class="fu">:</span> <span class="fu">{</span></a>
<a class="sourceLine" id="cb6-4" title="4">    <span class="dt">&quot;autoprefixer&quot;</span><span class="fu">:</span> <span class="st">&quot;^6.5.4&quot;</span></a>
<a class="sourceLine" id="cb6-5" title="5">  <span class="fu">},</span></a>
<a class="sourceLine" id="cb6-6" title="6">  <span class="dt">&quot;browserslist&quot;</span><span class="fu">:</span> <span class="ot">[</span></a>
<a class="sourceLine" id="cb6-7" title="7">    <span class="st">&quot;last 1 version&quot;</span><span class="ot">,</span></a>
<a class="sourceLine" id="cb6-8" title="8">    <span class="st">&quot;&gt; 1%&quot;</span><span class="ot">,</span></a>
<a class="sourceLine" id="cb6-9" title="9">    <span class="st">&quot;IE 10&quot;</span></a>
...
<h3 id="browserslistrc"><code>.browserslistrc</code></h3>
...
<div class="sourceCode" id="cb7"><pre class="sourceCode yaml"><code class="sourceCode yaml"><a class="sourceLine" id="cb7-1" title="1"><span class="co"># Browsers that we support</span></a>
<a class="sourceLine" id="cb7-2" title="2"></a>
<a class="sourceLine" id="cb7-3" title="3">last 1 version</a>
<a class="sourceLine" id="cb7-4" title="4">&gt; 1%</a>
<a class="sourceLine" id="cb7-5" title="5">IE 10 <span class="co"># sorry</span></a></code></pre></div>
...
<h2 id="shareable-configs">Shareable Configs</h2>
<p>You can use the following query to reference an exported Browserslist config from another package:</p>
<div class="sourceCode" id="cb8"><pre class="sourceCode json"><code class="sourceCode json"><a class="sourceLine" id="cb8-1" title="1">  <span class="er">&quot;browserslist&quot;:</span> <span class="ot">[</span></a>
<a class="sourceLine" id="cb8-2" title="2">    <span class="st">&quot;extends browserslist-config-mycompany&quot;</span></a>
<a class="sourceLine" id="cb8-3" title="3">  <span class="ot">]</span></a></code></pre></div>
...
<p>If you don’t accept Browserslist queries from users, you can disable the validation by using the or <code>BROWSERSLIST_DANGEROUS_EXTEND</code> environment variable.</p>
<div class="sourceCode" id="cb9"><pre class="sourceCode sh"><code class="sourceCode bash"><a class="sourceLine" id="cb9-1" title="1"><span class="va">BROWSERSLIST_DANGEROUS_EXTEND=</span>1 <span class="ex">npx</span> webpack</a></code></pre></div>
<p>Because this uses <code>npm</code>’s resolution, you can also reference specific files in a package:</p>
<div class="sourceCode" id="cb10"><pre class="sourceCode json"><code class="sourceCode json"><a class="sourceLine" id="cb10-1" title="1">  <span class="er">&quot;browserslist&quot;:</span> <span class="ot">[</span></a>
<a class="sourceLine" id="cb10-2" title="2">    <span class="st">&quot;extends browserslist-config-mycompany/desktop&quot;</span><span class="ot">,</span></a>
<a class="sourceLine" id="cb10-3" title="3">    <span class="st">&quot;extends browserslist-config-mycompany/mobile&quot;</span></a>
...
<div class="sourceCode" id="cb11"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb11-1" title="1"><span class="va">module</span>.<span class="at">exports</span> <span class="op">=</span> [</a>
<a class="sourceLine" id="cb11-2" title="2">  <span class="st">&#39;last 1 version&#39;</span><span class="op">,</span></a>
<a class="sourceLine" id="cb11-3" title="3">  <span class="st">&#39;&gt; 1%&#39;</span><span class="op">,</span></a>
<a class="sourceLine" id="cb11-4" title="4">  <span class="st">&#39;ie 10&#39;</span></a>
...
<a class="sourceLine" id="cb12-2" title="2">  <span class="dt">development</span><span class="op">:</span> [</a>
<a class="sourceLine" id="cb12-3" title="3">    <span class="st">&#39;last 1 version&#39;</span></a>
<a class="sourceLine" id="cb12-4" title="4">  ]<span class="op">,</span></a>
<a class="sourceLine" id="cb12-5" title="5">  <span class="dt">production</span><span class="op">:</span> [</a>
<a class="sourceLine" id="cb12-6" title="6">    <span class="st">&#39;last 1 version&#39;</span><span class="op">,</span></a>
<a class="sourceLine" id="cb12-7" title="7">    <span class="st">&#39;&gt; 1%&#39;</span><span class="op">,</span></a>
<a class="sourceLine" id="cb12-8" title="8">    <span class="st">&#39;ie 10&#39;</span></a>
<a class="sourceLine" id="cb12-9" title="9">  ]</a>
<a class="sourceLine" id="cb12-10" title="10"><span class="op">}</span></a></code></pre></div>
<h2 id="configuring-for-different-environments">Configuring for Different Environments</h2>
...
<div class="sourceCode" id="cb13"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb13-1" title="1">  <span class="st">&quot;browserslist&quot;</span><span class="op">:</span> <span class="op">{</span></a>
<a class="sourceLine" id="cb13-2" title="2">    <span class="st">&quot;production&quot;</span><span class="op">:</span> [</a>
<a class="sourceLine" id="cb13-3" title="3">      <span class="st">&quot;&gt; 1%&quot;</span><span class="op">,</span></a>
<a class="sourceLine" id="cb13-4" title="4">      <span class="st">&quot;ie 10&quot;</span></a>
<a class="sourceLine" id="cb13-5" title="5">    ]<span class="op">,</span></a>
<a class="sourceLine" id="cb13-6" title="6">    <span class="st">&quot;modern&quot;</span><span class="op">:</span> [</a>
<a class="sourceLine" id="cb13-7" title="7">      <span class="st">&quot;last 1 chrome version&quot;</span><span class="op">,</span></a>
<a class="sourceLine" id="cb13-8" title="8">      <span class="st">&quot;last 1 firefox version&quot;</span></a>
<a class="sourceLine" id="cb13-9" title="9">    ]<span class="op">,</span></a>
<a class="sourceLine" id="cb13-10" title="10">    <span class="st">&quot;ssr&quot;</span><span class="op">:</span> [</a>
<a class="sourceLine" id="cb13-11" title="11">      <span class="st">&quot;node 12&quot;</span></a>
<a class="sourceLine" id="cb13-12" title="12">    ]</a>
<a class="sourceLine" id="cb13-13" title="13">  <span class="op">}</span></a></code></pre></div>
<p>In <code>.browserslistrc</code> config:</p>
<div class="sourceCode" id="cb14"><pre class="sourceCode ini"><code class="sourceCode ini"><a class="sourceLine" id="cb14-1" title="1"><span class="kw">[production]</span></a>
<a class="sourceLine" id="cb14-2" title="2"><span class="dt">&gt; 1%</span></a>
<a class="sourceLine" id="cb14-3" title="3"><span class="dt">ie 10</span></a>
<a class="sourceLine" id="cb14-4" title="4"></a>
<a class="sourceLine" id="cb14-5" title="5"><span class="kw">[modern]</span></a>
<a class="sourceLine" id="cb14-6" title="6"><span class="dt">last 1 chrome version</span></a>
<a class="sourceLine" id="cb14-7" title="7"><span class="dt">last 1 firefox version</span></a>
<a class="sourceLine" id="cb14-8" title="8"></a>
<a class="sourceLine" id="cb14-9" title="9"><span class="kw">[ssr]</span></a>
<a class="sourceLine" id="cb14-10" title="10"><span class="dt">node 12</span></a></code></pre></div>
...
<pre><code>npx browserslist-ga</code></pre>
...
<a class="sourceLine" id="cb16-2" title="2">  <span class="st">&quot;ie&quot;</span><span class="op">:</span> <span class="op">{</span></a>
<a class="sourceLine" id="cb16-3" title="3">    <span class="st">&quot;6&quot;</span><span class="op">:</span> <span class="fl">0.01</span><span class="op">,</span></a>
<a class="sourceLine" id="cb16-4" title="4">    <span class="st">&quot;7&quot;</span><span class="op">:</span> <span class="fl">0.4</span><span class="op">,</span></a>
<a class="sourceLine" id="cb16-5" title="5">    <span class="st">&quot;8&quot;</span><span class="op">:</span> <span class="fl">1.5</span></a>
<a class="sourceLine" id="cb16-6" title="6">  <span class="op">},</span></a>
<a class="sourceLine" id="cb16-7" title="7">  <span class="st">&quot;chrome&quot;</span><span class="op">:</span> <span class="op">{</span></a>
...
<div class="sourceCode" id="cb17"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb17-1" title="1"><span class="kw">const</span> browserslist <span class="op">=</span> <span class="at">require</span>(<span class="st">&#39;browserslist&#39;</span>)</a>
<a class="sourceLine" id="cb17-2" title="2"></a>
<a class="sourceLine" id="cb17-3" title="3"><span class="co">// Your CSS/JS build tool code</span></a>
<a class="sourceLine" id="cb17-4" title="4"><span class="kw">function</span> <span class="at">process</span> (source<span class="op">,</span> opts) <span class="op">{</span></a>
<a class="sourceLine" id="cb17-5" title="5">  <span class="kw">const</span> browsers <span class="op">=</span> <span class="at">browserslist</span>(<span class="va">opts</span>.<span class="at">overrideBrowserslist</span><span class="op">,</span> <span class="op">{</span></a>
<a class="sourceLine" id="cb17-6" title="6">    <span class="dt">stats</span><span class="op">:</span> <span class="va">opts</span>.<span class="at">stats</span><span class="op">,</span></a>
<a class="sourceLine" id="cb17-7" title="7">    <span class="dt">path</span><span class="op">:</span>  <span class="va">opts</span>.<span class="at">file</span><span class="op">,</span></a>
<a class="sourceLine" id="cb17-8" title="8">    <span class="dt">env</span><span class="op">:</span>   <span class="va">opts</span>.<span class="at">env</span></a>
<a class="sourceLine" id="cb17-9" title="9">  <span class="op">}</span>)</a>
<a class="sourceLine" id="cb17-10" title="10">  <span class="co">// Your code to add features for selected browsers</span></a>
...
<div class="sourceCode" id="cb18"><pre class="sourceCode sh"><code class="sourceCode bash"><a class="sourceLine" id="cb18-1" title="1"><span class="ex">browserslist</span> <span class="st">&quot;&gt; 1%, IE 10&quot;</span></a></code></pre></div>
<p>You can get total users coverage for selected browsers by JS API:</p>
<div class="sourceCode" id="cb19"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb19-1" title="1"><span class="va">browserslist</span>.<span class="at">coverage</span>(<span class="at">browserslist</span>(<span class="st">&#39;&gt; 1%&#39;</span>))</a>
<a class="sourceLine" id="cb19-2" title="2"><span class="co">//=&gt; 81.4</span></a></code></pre></div>
<div class="sourceCode" id="cb20"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb20-1" title="1"><span class="va">browserslist</span>.<span class="at">coverage</span>(<span class="at">browserslist</span>(<span class="st">&#39;&gt; 1% in US&#39;</span>)<span class="op">,</span> <span class="st">&#39;US&#39;</span>)</a>
<a class="sourceLine" id="cb20-2" title="2"><span class="co">//=&gt; 83.1</span></a></code></pre></div>
<div class="sourceCode" id="cb21"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb21-1" title="1"><span class="va">browserslist</span>.<span class="at">coverage</span>(<span class="at">browserslist</span>(<span class="st">&#39;&gt; 1% in my stats&#39;</span>)<span class="op">,</span> <span class="st">&#39;my stats&#39;</span>)</a>
<a class="sourceLine" id="cb21-2" title="2"><span class="co">//=&gt; 83.1</span></a></code></pre></div>
<div class="sourceCode" id="cb22"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb22-1" title="1"><span class="va">browserslist</span>.<span class="at">coverage</span>(<span class="at">browserslist</span>(<span class="st">&#39;&gt; 1% in my stats&#39;</span><span class="op">,</span> <span class="op">{</span> stats <span class="op">}</span>)<span class="op">,</span> stats)</a>
<a class="sourceLine" id="cb22-2" title="2"><span class="co">//=&gt; 82.2</span></a></code></pre></div>
<p>Or by CLI:</p>
<div class="sourceCode" id="cb23"><pre class="sourceCode sh"><code class="sourceCode bash"><a class="sourceLine" id="cb23-1" title="1">$ <span class="ex">browserslist</span> --coverage <span class="st">&quot;&gt; 1%&quot;</span></a>
<a class="sourceLine" id="cb23-2" title="2"><span class="ex">These</span> browsers account for 81.4% of all users globally</a></code></pre></div>
<div class="sourceCode" id="cb24"><pre class="sourceCode sh"><code class="sourceCode bash"><a class="sourceLine" id="cb24-1" title="1">$ <span class="ex">browserslist</span> --coverage=US <span class="st">&quot;&gt; 1% in US&quot;</span></a>
<a class="sourceLine" id="cb24-2" title="2"><span class="ex">These</span> browsers account for 83.1% of all users in the US</a></code></pre></div>
<div class="sourceCode" id="cb25"><pre class="sourceCode sh"><code class="sourceCode bash"><a class="sourceLine" id="cb25-1" title="1">$ <span class="ex">browserslist</span> --coverage <span class="st">&quot;&gt; 1% in my stats&quot;</span></a>
<a class="sourceLine" id="cb25-2" title="2"><span class="ex">These</span> browsers account for 83.1% of all users in custom statistics</a></code></pre></div>
<div class="sourceCode" id="cb26"><pre class="sourceCode sh"><code class="sourceCode bash"><a class="sourceLine" id="cb26-1" title="1">$ <span class="ex">browserslist</span> --coverage <span class="st">&quot;&gt; 1% in my stats&quot;</span> --stats=./stats.json</a>
<a class="sourceLine" id="cb26-2" title="2"><span class="ex">These</span> browsers account for 83.1% of all users in custom statistics</a></code></pre></div>
...
<div class="sourceCode" id="cb27"><pre class="sourceCode sh"><code class="sourceCode bash"><a class="sourceLine" id="cb27-1" title="1"><span class="va">BROWSERSLIST=</span><span class="st">&quot;&gt; 5%&quot;</span> <span class="ex">npx</span> webpack</a></code></pre></div></li>
<li><p><code>BROWSERSLIST_CONFIG</code> with path to config file.</p>
<div class="sourceCode" id="cb28"><pre class="sourceCode sh"><code class="sourceCode bash"><a class="sourceLine" id="cb28-1" title="1"><span class="va">BROWSERSLIST_CONFIG=</span>./config/browserslist <span class="ex">npx</span> webpack</a></code></pre></div></li>
<li><p><code>BROWSERSLIST_ENV</code> with environments string.</p>
<div class="sourceCode" id="cb29"><pre class="sourceCode sh"><code class="sourceCode bash"><a class="sourceLine" id="cb29-1" title="1"><span class="va">BROWSERSLIST_ENV=</span><span class="st">&quot;development&quot;</span> <span class="ex">npx</span> webpack</a></code></pre></div></li>
<li><p><code>BROWSERSLIST_STATS</code> with path to the custom usage data for <code>&gt; 1% in my stats</code> query.</p>
<div class="sourceCode" id="cb30"><pre class="sourceCode sh"><code class="sourceCode bash"><a class="sourceLine" id="cb30-1" title="1"><span class="va">BROWSERSLIST_STATS=</span>./config/usage_data.json <span class="ex">npx</span> webpack</a></code></pre></div></li>
<li><p><code>BROWSERSLIST_DISABLE_CACHE</code> if you want to disable config reading cache.</p>
<div class="sourceCode" id="cb31"><pre class="sourceCode sh"><code class="sourceCode bash"><a class="sourceLine" id="cb31-1" title="1"><span class="va">BROWSERSLIST_DISABLE_CACHE=</span>1 <span class="ex">npx</span> webpack</a></code></pre></div></li>
<li><p><code>BROWSERSLIST_DANGEROUS_EXTEND</code> to disable security shareable config name check.</p>
<div class="sourceCode" id="cb32"><pre class="sourceCode sh"><code class="sourceCode bash"><a class="sourceLine" id="cb32-1" title="1"><span class="va">BROWSERSLIST_DANGEROUS_EXTEND=</span>1 <span class="ex">npx</span> webpack</a></code></pre></div></li>
</ul>
...
<div class="sourceCode" id="cb33"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb33-1" title="1"><span class="va">browserslist</span>.<span class="at">clearCaches</span>()</a></code></pre></div>
