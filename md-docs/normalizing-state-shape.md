...
# <span id="normalizing-state-shape" class="anchor enhancedAnchor_2LWZ"></span>Normalizing State Shape<a href="#normalizing-state-shape" class="hash-link" title="Direct link to heading">#</a>
