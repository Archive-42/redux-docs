...
- <a href="#!" class="menu__link menu__link--sublist menu__link--active">Recipes</a>
  - <a href="recipe-index.html" class="menu__link menu__link--active active">Recipes: Index</a>
...
# <span id="recipes" class="anchor enhancedAnchor_2LWZ"></span>Recipes<a href="#recipes" class="hash-link" title="Direct link to heading">#</a>

These are some use cases and code snippets to get you started with Redux in a real app. They assume you understand the topics in [the "Redux Fundamentals" tutorial](../tutorials/fundamentals/part-1-overview.html).

- [Configuring Your Store](configuring-your-store.html)
- [Usage with TypeScript](usage-with-typescript.html)
- [Migrating to Redux](migrating-to-redux.html)
- [Using Object Spread Operator](using-object-spread-operator.html)
- [Reducing Boilerplate](reducing-boilerplate.html)
- [Server Rendering](server-rendering.html)
- [Writing Tests](writing-tests.html)
- [Computing Derived Data](computing-derived-data.html)
- [Implementing Undo History](implementing-undo-history.html)
- [Isolating Redux Sub-Apps](isolating-redux-sub-apps.html)
- [Code Splitting](code-splitting.html)
- [Troubleshooting](troubleshooting.html)
- [Structuring Reducers](structuring-reducers/structuring-reducers.html)

<a href="../tutorials/fundamentals/part-8-modern-redux.html" class="pagination-nav__link"></a>
